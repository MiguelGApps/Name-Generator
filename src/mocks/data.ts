...
export const nameListTestResultMockFull = [
  { name: "Liam", number: 387 },
  { name: "Jacob", number: 351 },
  { name: "Joseph", number: 261 },
  { name: "Michael", number: 260 },
  { name: "Ethan", number: 193 },
  { name: "Ryan", number: 160 },
  { name: "Noah", number: 148 },
  { name: "Aiden", number: 137 },
];


export const nameListTestResultRemoveMock = [
  { name: "Liam", number: 387 },
  { name: "Jacob", number: 351 },
  { name: "Joseph", number: 261 },
  { name: "Michael", number: 260 },
